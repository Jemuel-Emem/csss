<div class="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg w-7xl mx-auto">
    ...
    @foreach (['daily' => $dailyData, 'weekly' => $weeklyData, 'yearly' => $yearlyData] as $label => $data)
        <div class="w-full max-w-7xl bg-gray-100 rounded-lg shadow-md p-6 mb-6">
            ...
            <p class="text-lg">
                Overall Rating:
                <span class="@if($data['score'] < 60) text-red-600 font-bold
            ...
            <!-- Show NA percentage separately -->
            @if($data['naPercentage'] > 0)
                <p class="text-lg mt-2">
                    Not Applicable Responses:
                    <span class="font-bold">{{ $data['naPercentage'] }}%</span>
                </p>
            @endif

            <!-- Chart for valid responses only -->
            <div class="relative flex justify-center items-center w-full max-w-7xl bg-white rounded-lg shadow-md p-6 mt-4">
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribution of Valid Responses (excluding Not Applicable)',
                            font: { size: 16 }
                        }
                    },
                    animation: {
